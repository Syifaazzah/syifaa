...
<div class="container mt-5">
    ...
    <form action="hasil.php" method="post" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="nilai" name="nilai1" min="0" max="100" required>
        </div>
        <div class="mb-3">
            <label for="nilai" class="form-label">Nilai2:</label>
            <input type="number" class="form-control" id="nilai" name="nilai2" min="0" max="100" required>
        </div>
        <div class="mb-3">
            <label for="nilai" class="form-label">uts:</label>
            <input type="number" class="form-control" id="nilai" name="uts" min="0" max="100" required>
        </div>
        <div class="mb-3">
            <label for="nilai" class="form-label">uas:</label>
            <input type="number" class="form-control" id="nilai" name="uas" min="0" max="100" required>
        </div>
        <div class="mb-3">
            <label for="nilai" class="form-label">absen:</label>
            <input type="number" class="form-control" id="nilai" name="absen" min="0" max="100" required>
